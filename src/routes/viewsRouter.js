// creo el router de vistas para instanciarlo en mi app.js
// las vistas que debo tener son:
// - home: listado de productos
// - realTimeProducts: listado de productos en tiempo real y agrego productos nuevos usando websockets
